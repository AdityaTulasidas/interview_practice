...
public class ExecutionContext {
    ...
    private DataSyncActivityContext dataSyncActivityCtx;
    ...
    public void setContextByName(String name, ExecutionContextBase ctx) throws ExecutionContextException {
        if (name == null) {
            throw new ExecutionContextException("Context name cannot be null");
        } else if (ctx == null) {
            throw new ExecutionContextException("Context instance cannot be null for name:: " + name);
        } else {
            switch (name.toLowerCase()) {
                case "global":
                    if (!(ctx instanceof GlobalContext)) {
                        throw new ExecutionContextException("Invalid context instance provided. Expected:: GlobalContext, Received:: " + ctx.getClass().getName());
                    }
                ...
                case "job":
                    if (!(ctx instanceof RegionalJobContext)) {
                        throw new ExecutionContextException("Invalid context instance provided. Expected:: RegionalJobContext, Received:: " + ctx.getClass().getName());
                    }
                ...
                case "inadp":
                    if (!(ctx instanceof AdapterContext)) {
                        throw new ExecutionContextException("Invalid context instance provided. Expected:: Input AdapterContext, Received:: " + ctx.getClass().getName());
                    }
                ...
                case "outadp":
                    if (!(ctx instanceof AdapterContext)) {
                        throw new ExecutionContextException("Invalid context instance provided. Expected:: Output AdapterContext, Received:: " + ctx.getClass().getName());
                    }
                ...
                case "transfrom":
                    if (!(ctx instanceof TransformationContext)) {
                        throw new ExecutionContextException("Invalid context instance provided. Expected:: TransformationContext, Received:: " + ctx.getClass().getName());
                    }
                ...
                case "datasyncactivity":
                    if (!(ctx instanceof DataSyncActivityContext)) {
                        throw new ExecutionContextException("Invalid context instance provided. Expected:: DataSyncActivityContext, Received:: " + ctx.getClass().getName());
                    }

                    this.dataSyncActivityCtx = (DataSyncActivityContext)ctx;
                    break;
                default:
                    throw new ExecutionContextException("Unknown context name provided to get context instance:: " + name);
            }
