...
import com.ETLExecutionEngine.context.executioncontext.AdapterContext;
import com.ETLExecutionEngine.context.executioncontext.ExecutionContext;
import com.ETLExecutionEngine.context.executioncontext.GlobalContext;
import com.ETLExecutionEngine.context.executioncontext.RegionalJobContext;
import com.aditya.dataconnect.executionengine.adapters.CommonAdaptersUtil;
import com.aditya.dataconnect.executionengine.adapters.IntegrationAdapter;
...
import com.aditya.dataconnect.executionengine.model.pojo.DataUnitList;
...
import static com.aditya.dataconnect.executionengine.adapters.CommonAdaptersUtil.sanitizeAndValidateObjIds;
...
public class DatabaseAdapter implements IntegrationAdapter {
    ...
    private DataSet readDataForSpecificIds(MetaObjectDTO metaObj, int hierarchyIndex, PrimaryKeyInfo primaryKeyInfo, List<?> objIds, Connection connection, RegionalJobContext regionalJobCtx, String tableType, LocalDateTime lastUpdatedTime) throws DataSyncJobException, SQLException {
        ...
        if (tableType != null && tableType.equalsIgnoreCase("lookup")) {
            ...
            processDataCollection(dataSet, metaObj, selectQuery, objIds, primaryKeyInfo, execType, tenantId, connection, tableType,null); //making foreign key as null when primary key is present
        }
...
//                    String updatedAt= SQLBuilder.getUpdatedAt(metaObj);
//                    if(!tableType.equalsIgnoreCase("parent") && updatedAt!=null && !updatedAt.isEmpty()){
//                        index++;
